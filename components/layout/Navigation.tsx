  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200">
      <div className="flex items-center justify-around h-16 md:h-20 max-w-6xl mx-auto px-4">
        ...
        <button
          type="button"
          className="flex items-center justify-center p-2 md:p-3 text-[var(--color-gray-medium)] hover:text-[var(--color-brown-accent)] active:text-[var(--color-brown-accent)] transition-colors"
          aria-label="홈"
        >
