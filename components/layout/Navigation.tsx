  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200">
      <div className="flex items-center justify-around h-16 md:h-20 max-w-6xl mx-auto px-4">
        ...
        {/* 게시글 작성 버튼 */}
        <Link href="/book-registration" className={getLinkClassName('/book-registration')} aria-label="게시글 작성">
        ...
        {/* 마이페이지 버튼 */}
        <Link href="/user/mypage" className={getLinkClassName('/user/mypage')} aria-label="마이페이지">
